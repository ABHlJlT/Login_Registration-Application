...
public class Register extends HttpServlet {
	private static final long serialVersionUID = 4909124230502332027L;
	...
	private static String JDBCConnection(String st) {
		...
		try {
	Conn = DriverManager.getConnection("jdbc:mysql://sql12.freemysqlhosting.net:3306/sql12192611",
					"sql12192611", "XWch1xppLf");
			if (Conn != null) {
			}else {
	...
	private static String registration(String fname, String lname, String email, String phn, String pwd, String op) {
		...
		try {
			...
			ps = Conn.prepareStatement("select * from temp where email=?");
